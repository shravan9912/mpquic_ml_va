...
- Changed the log level environment variable to only accept strings ("DEBUG", "INFO", "ERROR"), see [the wiki](https://github.com/shravan9912/mpquic_ml_va/wiki/Logging) for more details.
