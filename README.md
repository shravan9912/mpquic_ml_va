...
mpquic_ml is a multipath implementation of the [quic-go](https://github.com/lucas-clemente/quic-go) protocol
...
This version of mpquic_ml is not dependent on quic-go, and can be installed as a standalone package
...
An application that does File Transfer using mpquic_ml has been shown at [MPQUIC-FTP](https://github.com/shravan9912/mpquic_ftp)
